...
from src.create_todo import lambda_handler

class CreateTodoTestCase(unittest.TestCase):
    """
    Tests create_todo
    """
    ...
    def test_lambda_handler_create_object_success(self):
        """
        Test Lambda Handler
        """
        ...
        self.assertEqual('To-Do object created successfully.', body_json['message'])
        self.assertEqual('1111111111', json_object['id'])


    @mock_s3
    @mock.patch.dict(os.environ, {"BUCKET_STORAGE": "testbucket"})
    def test_lambda_handler_create_object_invalid_dict(self):
        """
        Test Lambda Handler
        """
        ...
        self.assertEqual('There was an error while creating a new To-Do object.', body_json['error'])
